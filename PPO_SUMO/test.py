...
MODEL_PATH      = os.path.join(SCRIPT_DIR, "models", "sweep_sp03" ,"ppo_sumo_2junction")
NORMALIZER_PATH = os.path.join(SCRIPT_DIR, "models","sweep_sp03" , "vec_normalize_sumo.pkl")
